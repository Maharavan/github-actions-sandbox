...
def run():
    bucket = os.environ['INPUT_BUCKETS'] # docker action will have environment variable starting with INPUT_<WORKFLOW_VARIABLE>
    bucket_region = os.environ['INPUT_BUCKETS-REGION']
